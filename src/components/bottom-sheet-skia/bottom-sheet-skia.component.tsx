...
export function BottomSheetGustavao({
  minHeight,
  children,
  maxHeight,
}: BottomSheetGustavaoProps) {
  ...
  const gesture = Gesture.Pan()
    ...
    .onEnd((e) => {
      ...
      const somaElementosDaTelaHeight =
        56 + 60 + (StatusBar.currentHeight || 0);
      ...
      if (e.absoluteY < distanceToOpen) {
        ...
        translateY.value = withSpring(
          maxHeight ? distanceToOpen - maxHeight : 8,
          {
            mass: 1,
            damping: 50,
            stiffness: 50,
